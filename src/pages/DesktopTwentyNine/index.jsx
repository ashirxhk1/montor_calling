        ...
        <div className="flex flex-col items-center justify-end w-full">
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
            <Sidebar
              ...
              className="!sticky !w-[316px] bg-white-A700 flex h-screen md:hidden justify-start overflow-auto md:px-5 shadow-bs1 top-[0]"
            >
              <Img
              ...
              <Menu
                ...
                className="flex flex-col items-center justify-start mb-[505px] mt-[30px] w-full"
              >
