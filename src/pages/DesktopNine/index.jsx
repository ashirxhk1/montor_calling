    ...
    <>
      <div className="bg-purple-700_63 flex flex-col font-poppins items-center justify-end mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex-1 md:h-[1017px] h-[1067px] md:px-5 relative w-full">
            ...
            <div className="absolute bg-gray-900_4c flex flex-col font-poppins inset-x-[0] items-center justify-start mx-auto p-[265px] md:px-10 sm:px-5 top-[0] w-full">
              <div className="bg-white-A700 flex flex-col justify-start mb-[205px] p-[25px] sm:px-5 rounded-[33px] w-[99%] md:w-full">
                <Img
                  className="h-[21px] md:ml-[0] ml-[507px] w-[21px]"
                  src="images/img_arrowright_black_900_01.svg"
                  alt="arrowright"
                />
                <Text
                  className="mt-[11px] mx-auto sm:text-[27.34px] md:text-[29.34px] text-[31.34px] text-black-900_01 text-center w-3/4 sm:w-full"
                  size="txtPoppinsMedium3134"
                >
                  Waiting for Adiel Omari to Join
                </Text>
                <div className="bg-gray-100_04 border border-gray-900_1e border-solid flex flex-col items-end justify-end mb-[47px] md:ml-[0] ml-[178px] mr-[191px] mt-[23px] p-[17px] rounded-bl-[24px] rounded-br-[25px] rounded-tl-[24px] rounded-tr-[25px] w-[31%] md:w-full">
                  <Img
