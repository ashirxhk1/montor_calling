...
const LoginSixteenPage = () => {
  return (
    <>
      <div className="bg-white-A700_b2 font-proximasoft h-[900px] mx-auto pb-[30px] relative w-full">
        <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto top-[0] w-full">
          <div className="flex flex-col gap-14 justify-start w-full">
            <div className="bg-purple-700 flex md:flex-col flex-row md:gap-10 items-center justify-between p-[57px] md:px-10 sm:px-5 w-full">
              <div className="flex md:flex-1 flex-col gap-7 items-center justify-start w-[22%] md:w-full">
              ...
              <div className="md:h-[201px] h-[312px] mb-3 mr-[3px] md:mt-0 mt-5 relative w-[29%] md:w-full">
        ...
        <div
          className="absolute bg-cover bg-no-repeat bottom-[3%] flex flex-col h-[786px] inset-x-[0] items-center justify-start mx-auto p-[23px] md:px-5 w-[44%]"
        ...
        >
          <div className="flex flex-col items-start justify-start mb-[5px] mt-2.5 w-[98%] md:w-full">
            <Text
              className="md:ml-[0] ml-[5px] sm:text-[35.6px] md:text-[41.6px] text-[45.6px] text-black-900"
              size="txtProximaSoftSemiBold456"
            >
              Choose Your Role
            </Text>
            <Text
              className="ml-2.5 md:ml-[0] mt-[37px] sm:text-[23.36px] md:text-[25.36px] text-[27.36px] text-gray-700_02"
            ...
            <div className="flex sm:flex-col flex-row font-poppins gap-[9px] items-center justify-between mt-[89px] w-[99%] md:w-full">
              <Button
            ...
            <Button
              className="!text-gray-100 cursor-pointer font-poppins h-[82px] leading-[normal] ml-2.5 md:ml-[0] mt-[331px] rounded-[41px] shadow-bs5 sm:text-[26.4px] md:text-[28.4px] text-[30.4px] text-center w-[556px]"
              size="2xl"
            >
              Next
            </Button>
