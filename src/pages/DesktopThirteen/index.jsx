      ...
      <div className="bg-white-A700 font-poppins h-[1114px] mx-auto relative w-full">
        ...
        <div className="absolute bottom-[0] flex md:flex-col flex-row md:gap-5 inset-x-[0] items-start justify-evenly mx-auto w-full">
          <Sidebar
            ...
            className="!sticky !w-[321px] bg-white-A700 flex h-screen md:hidden justify-start overflow-auto md:px-5 shadow-bs1 top-[0]"
          >
            <Img
              className="h-[173px] md:h-auto md:ml-[0] ml-[71px] mr-20 mt-[25px] object-cover w-[53%]"
            ...
            <Menu
              ...
              className="flex flex-col items-center justify-end mb-[608px] mt-[30px] w-full"
            >
          ...
          <div className="bg-gray-900_1e flex flex-1 flex-col font-proximasoft items-center justify-start p-[15px] md:px-5 shadow-bs14 w-full">
