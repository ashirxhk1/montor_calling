    ...
    <>
      <div className="bg-purple-700_63 flex flex-col font-poppins items-center justify-end mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex-1 md:h-[1020px] h-[1067px] md:px-5 relative w-full">
            ...
            <div className="absolute bg-gray-900_4c flex flex-col font-poppins inset-x-[0] items-start justify-start mx-auto p-[214px] md:px-10 sm:px-5 top-[0] w-full">
              <div className="bg-white-A700 flex flex-col justify-start mb-[214px] md:ml-[0] ml-[72px] p-[21px] sm:px-5 rounded-[27px] w-[71%] md:w-full">
                <Img
                  className="h-[18px] md:ml-[0] ml-[426px] w-[18px]"
                  src="images/img_arrowright_black_900_01.svg"
                  alt="arrowright"
                />
                <Text
                  className="mx-auto sm:text-[22.34px] md:text-[24.34px] text-[26.34px] text-black-900_01 text-center w-3/4 sm:w-full"
                  size="txtPoppinsMedium2634"
                >
                  Do you want to join the session now?
                </Text>
                <div className="flex flex-row gap-2.5 items-center justify-center md:ml-[0] ml-[148px] mt-[11px] w-[33%] md:w-full">
                  <Img
                    className="h-[27px] w-[27px]"
                    src="images/img_phclock.svg"
                    alt="phclock"
                  />
                  <Text
                    className="text-[19.76px] text-blue_gray-700"
                    size="txtPoppinsMedium1976"
                  >
                    1 min more
                  </Text>
                </div>
                <div className="flex flex-col gap-[29px] items-center justify-start mb-[25px] md:ml-[0] ml-[135px] mt-[47px] w-[41%] md:w-full">
                  <Button
                    className="border border-purple-700 border-solid cursor-pointer h-[54px] leading-[normal] rounded-[27px] shadow-bs5 text-[16.01px] text-center w-[181px]"
                    shape="round"
                  >
                    Join Now
                  </Button>
                  <Button
                    className="!text-black-900 cursor-pointer h-[54px] leading-[normal] rounded-[27px] shadow-bs12 text-[16.01px] text-center w-[181px]"
                    shape="round"
                    variant="outline"
                  >
                    Cancel
