          ...
          <div className="flex md:flex-col flex-row gap-[35px] items-start justify-between w-full">
            ...
            <div className="flex flex-1 flex-col font-proximasoft gap-[23px] justify-start w-full">
              ...
              <div className="bg-gray-400_01 flex flex-col font-poppins gap-[21px] items-center justify-center p-[30px] sm:px-5 rounded-[20px] shadow-bs3 w-full">
                ...
                <div className="h-[394px] md:h-[727px] mb-[349px] relative w-[99%] md:w-full">
                  ...
                  <div className="absolute bg-white-A700 flex flex-col h-max inset-[0] justify-center m-auto p-[21px] sm:px-5 rounded-[27px] w-[51%]">
                    <Img
                    ...
                    />
                    <Text
                      className="mx-auto sm:text-[22.21px] md:text-[24.21px] text-[26.21px] text-black-900_01 text-center w-3/4 sm:w-full"
                      size="txtPoppinsMedium2621"
                    >
                      Do you want to join the session now?
                    </Text>
                    <div className="flex flex-row gap-2.5 items-center justify-center md:ml-[0] ml-[148px] mt-2.5 w-[33%] md:w-full">
                      <Img
                      ...
                      />
                      <Text
                        className="text-[19.66px] text-blue_gray-700"
                        size="txtPoppinsMedium1966"
                      >
                        1 min more
                      </Text>
                    </div>
                    <div className="flex flex-col gap-[29px] items-center justify-start mb-[25px] md:ml-[0] ml-[135px] mt-12 w-[41%] md:w-full">
                      <Button
                        className="border border-purple-700 border-solid cursor-pointer h-[54px] leading-[normal] rounded-[27px] shadow-bs5 text-[15.93px] text-center w-[181px]"
                        shape="round"
                      >
                        Join Now
                      </Button>
                      <Button
                        className="!text-black-900 cursor-pointer h-[54px] leading-[normal] rounded-[27px] shadow-bs15 text-[15.93px] text-center w-[181px]"
                        shape="round"
                        variant="outline"
                      >
                        Cancel
