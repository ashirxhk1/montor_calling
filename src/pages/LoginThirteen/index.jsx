...
const LoginThirteenPage = () => {
  return (
    <>
      <div className="bg-white-A700_b2 font-proximasoft h-[900px] mx-auto pb-[70px] relative w-full">
        <div className="absolute bg-purple-700 flex md:flex-col flex-row md:gap-10 inset-x-[0] items-start justify-between mx-auto p-11 md:px-10 sm:px-5 top-[0] w-full">
          ...
          <div className="md:h-[189px] h-[312px] mr-[65px] md:mt-0 mt-[58px] relative w-[29%] md:w-full">
        ...
        <div className="absolute md:h-[741px] h-[745px] inset-[0] justify-center m-auto md:px-5 rounded-[26px] shadow-bs3 w-[41%] sm:w-full">
          <div className="absolute bg-white-A700 flex flex-col font-proximasoft h-full inset-[0] justify-center m-auto rounded-[26px] shadow-bs10 w-full">
            <Img
              className="h-[209px] md:h-auto md:ml-[0] ml-[183px] rounded-[50%] w-[209px]"
              src="images/img_ellipse19.png"
              alt="ellipseNineteen"
            />
            <Text
              className="md:ml-[0] ml-[53px] mt-[77px] sm:text-[32.91px] md:text-[34.91px] text-[36.91px] text-gray-900"
              size="txtProximaSoftSemiBold3691"
            >
              Welcome Back, Imani!
            </Text>
            <LoginEightColumnoutlineusers
              className="flex flex-col font-poppins gap-[24.61px] items-start justify-start mb-[185px] mt-[27px] mx-auto w-auto sm:w-full"
              logintoshiftwor3="Enter password"
              eye="images/img_eye.svg"
              bycheckingthe="Remember me"
            />
          </div>
          <Button className="!text-gray-100 absolute bottom-[0] cursor-pointer font-poppins h-[66px] inset-x-[0] leading-[normal] mx-auto rounded-[33px] shadow-bs5 sm:text-[20.61px] md:text-[22.61px] text-[24.61px] text-center w-[450px]">
            Login
          </Button>
        </div>
      </div>
