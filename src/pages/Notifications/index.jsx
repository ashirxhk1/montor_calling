        ...
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          <Sidebar className="!sticky !w-[316px] bg-white-A700 flex h-screen md:hidden justify-start overflow-auto md:px-5 top-[0]">
            ...
            <Menu
              ...
              className="flex flex-col items-center justify-start mb-[625px] mt-[51px] w-full"
            >
              <SubMenu
                icon={
                  <Img
                ...
                label={<Text className="mt-0.5">Management</Text>}
              >
          ...
          <div className="flex flex-1 flex-col font-proximasoft gap-[17px] items-center justify-start md:px-5 w-full">
            ...
            <div className="flex md:flex-col flex-row gap-[19px] items-start justify-between w-[97%] md:w-full">
              <div className="bg-white-A700 flex flex-col items-center justify-start p-[26px] sm:px-5 rounded-[35px] w-[27%] md:w-full">
                <div className="flex flex-col gap-9 justify-start mb-[236px] mt-[7px] w-full">
                  <div className="flex flex-col gap-[26px] items-start justify-start md:ml-[0] ml-[7px] w-[91%] md:w-full">
                    ...
                    <div className="border border-gray-400_02 border-solid flex flex-row font-opensans gap-[15px] items-center justify-start p-[7px] rounded-[10px] w-full">
                      <Img
                      ...
                      />
                      <Text
                        className="mt-0.5 text-gray-500_03 text-xs"
                        size="txtOpenSans12"
                      >
              ...
              <div className="flex flex-col font-poppins gap-[17px] items-center justify-start w-[73%] md:w-full">
                <div className="overflow-x-auto w-full">
                  <div className="bg-white-A700 flex md:flex-col flex-row md:gap-5 items-center justify-end overflow-auto pl-[18px] py-[18px] rounded-[10px] shadow-bs22 w-full">
                    <Text
                      className="border border-gray-300_01 border-solid pb-[35px] pl-3 sm:pr-5 pr-[35px] pt-3.5 rounded-[12px] text-gray-500 text-sm tracking-[0.42px]"
                      size="txtPoppinsLight14"
                    >
                      Write Message to send it to All...
                    </Text>
                    <Img
                      className="h-[45px] ml-1.5 md:ml-[0] w-[45px]"
                      src="images/img_save.svg"
                      alt="save"
                    />
                    <Img
                      className="h-[45px] md:ml-[0] ml-[197px] w-[45px]"
                      src="images/img_save.svg"
                      alt="save_One"
                    />
                  </div>
                </div>
                <div className="bg-white-A700 flex flex-col md:gap-10 gap-28 items-center justify-start p-[26px] sm:px-5 rounded-[26px] w-full">
                  <div className="flex flex-col items-center justify-start mt-[9px] w-[98%] md:w-full">
                    <div className="flex flex-col justify-start w-full">
                      ...
                      >
                        ...
                        >
                          ...
                          bring to your attention a concerning issue regarding a
                          recent transaction I made on your platform. On 25 of
                          this month, I purchased a power bank and made the
                          payment successfully. However, despite the completion
                          of the payment process, I have yet to receive the
                          power bank. I would like to emphasize the urgency of
                          this matter, as the power bank was intended to be a
                          necessary tool for my upcoming travels. As a paying
                          customer, I have a reasonable expectation of receiving
                      ...
                      >
                        ...
                        >
                          <>
                            OK, let ne check the transactions and once I confirm
                            I will release the batteries but kindly don’t leave
                            the station till the confirmation once I release the
                            batteries and you have left the station then it will
                  ...
                  <div className="flex md:flex-col flex-row font-opensans gap-4 items-center justify-start mb-7 w-[97%] md:w-full">
                    <Input
                      name="groupNineteen"
                      placeholder="Write your message..."
                      className="font-semibold leading-[normal] p-0 placeholder:text-gray-500_03 text-left text-lg w-full"
                      wrapClassName="rounded-[10px] w-[92%] md:w-full"
                      shape="round"
                      color="gray_500"
                      size="3xl"
                      variant="outline"
