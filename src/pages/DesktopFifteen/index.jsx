    ...
    <>
      <div className="bg-purple-700_63 flex flex-col font-poppins items-center justify-end mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-center justify-evenly w-full">
          <div className="h-[1031px] md:px-5 relative w-[22%] md:w-full">
            <Img
              className="h-[29px] ml-[41px] mt-[252px] w-[29px]"
              src="images/img_profile.svg"
              alt="profile"
            />
            <Sidebar11 className="!sticky !w-[316px] bg-white-A700 flex h-screen md:hidden inset-[0] justify-center m-auto overflow-auto shadow-bs1 top-[0]" />
          </div>
          <div className="md:h-[1021px] h-[1060px] md:mt-0 mt-[7px] md:px-5 relative w-[79%] md:w-full">
            ...
            <div className="absolute bg-gray-900_4c flex flex-col font-poppins h-max inset-[0] items-center justify-center m-auto p-[290px] md:px-10 sm:px-5 w-full">
              <div className="bg-white-A700 flex flex-col items-center justify-end mb-[38px] p-[49px] md:px-10 sm:px-5 rounded-[26px] w-[94%] md:w-full">
                <div className="flex flex-col items-center justify-start mt-[11px] w-[74%] md:w-full">
                  <div className="h-[115px] relative w-[42%]">
                    <div className="bg-purple-700 h-[115px] m-auto rounded-[62px] w-full"></div>
                    <Img
                      className="absolute h-[93px] inset-x-[0] mx-auto top-[2%] w-[93px]"
                      src="images/img_heroiconssolidthumbup.svg"
                      alt="heroiconssolidt"
                    />
                  </div>
                  <Text
                    className="mt-7 sm:text-2xl md:text-[26px] text-[28px] text-black-900_01 text-center"
                    size="txtPoppinsSemiBold28"
                  >
                    Review Submitted
                  </Text>
                  <Text
                    className="mt-0.5 text-[16.57px] text-black-900_01 text-center"
                    size="txtPoppinsRegular1657"
                  >
                    <>
                      Thanks Robbet.Your review helps us <br />
                      to better recommend
                    </>
                  </Text>
                  <Text
                    className="mt-[31px] sm:text-[16.71px] md:text-[18.71px] text-[20.71px] text-purple-700 underline"
                    size="txtPoppinsMedium2071"
                  >
                    Refer to Friend
                  </Text>
                </div>
