...
const LoginFourteenPage = () => {
  return (
    <>
      <div className="bg-white-A700_b2 flex flex-col font-proximasoft mx-auto pb-[37px] relative w-full">
        <div className="bg-purple-700 flex md:flex-col flex-row md:gap-10 items-start justify-between mx-auto p-[52px] md:px-10 sm:px-5 w-full">
          <div className="flex md:flex-1 flex-col gap-7 items-center justify-start md:ml-[0] ml-[5px] md:mt-0 mt-[175px] w-[21%] md:w-full">
          ...
          <div className="md:h-[189px] h-[312px] mr-6 md:mt-0 mt-[42px] relative w-[29%] md:w-full">
        ...
        <div className="flex flex-col font-poppins items-center justify-start mb-[137px] ml-[73px] mt-[-NaNpx] md:px-5 w-[23%] z-[1]">
        ...
        <div
          className="bg-cover bg-no-repeat flex flex-col h-[779px] items-start justify-start ml-[394px] mt-[-374px] p-[22px] md:px-5 rounded-[26px] w-[41%] z-[1]"
          style={{ backgroundImage: "url('images/img_group85.svg')" }}
        >
          <div className="flex flex-col gap-11 items-start justify-start mb-[11px] md:ml-[0] ml-[19px] w-[86%] md:w-full">
            <Text
            ...
            <LoginEightColumnoutlineusers
              className="flex flex-col font-poppins gap-[25.55px] items-start justify-start w-auto sm:w-full"
              bycheckingthe={
                <Text className="leading-[25.00px] max-w-[422px] md:max-w-full text-[17.88px] text-gray-900_66">
              ...
              eye1="images/img_eye.svg"
              linearsecurity="images/img_linearsecurity.svg"
            />
            <Button className="!text-gray-100 cursor-pointer font-poppins h-[68px] leading-[normal] rounded-[34px] shadow-bs5 sm:text-[21.55px] md:text-[23.55px] text-[25.55px] text-center w-[467px]">
              Next
            </Button>
          </div>
        </div>
